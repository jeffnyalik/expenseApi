...
urlpatterns = [
    ...
    path('update-profile/<int:id>/', views.UpdateProfileView.as_view(), name='update-profile'),
    path('change-user-password/<int:id>/', views.ChangePasswordApiView.as_view(), name='change-user-password'),
